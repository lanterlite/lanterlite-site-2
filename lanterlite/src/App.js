    ...
    return (
	  ...
	  {/* <section style={ sectionStyle }> */}
			<div id="label">
		  	...
		  	<div id="nav-bar">
			<ul>
			<li><a style={{ fontFamily:"lanterlite_cambria", fontSize: 17 }} href="#" ><font >ISLAM</font></a></li>
			<li><a style={{ fontFamily:"lanterlite_cambria", fontSize: 17 }} ><font >TECHNOLOGY</font></a></li>
			...
			<div id="home-post-bottom">
				...
				<tbody>
				<tr>
					<td style={styles.td_footer} ><img src={footer_img_1} style={styles.footer} /></td>
					<td style={styles.td_footer} ><img src={footer_img_2} style={styles.footer} /></td>
					<td style={styles.td_footer} ><img src={footer_img_3} style={styles.footer} /></td>
					<td style={styles.td_footer} ><img src={footer_img_4} style={styles.footer} /></td>
					<td style={styles.td_footer} ><img src={footer_img_5} style={styles.footer} /></td>
				</tr>
